...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-dark-900 text-slate-800 dark:text-slate-200 transition-colors duration-300 relative px-4 overflow-hidden">
      {/* Glow Orbs */}
      <div className="absolute top-[20%] left-[20%] w-[35vw] h-[35vw] rounded-full bg-primary-500/10 blur-[80px] pointer-events-none"></div>
      <div className="absolute bottom-[20%] right-[20%] w-[30vw] h-[30vw] rounded-full bg-indigo-500/10 blur-[80px] pointer-events-none"></div>
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400">Sign in to manage your resume reviews & jobs</p>
        </div>
        ...
        <div className="glass-panel border border-slate-200/50 dark:border-slate-800/40 rounded-3xl p-8 shadow-xl">
          ...
          <div className="relative my-6 flex items-center justify-center">
            ...
            <span className="bg-slate-50 dark:bg-dark-800 px-3 text-[10px] text-slate-400 uppercase tracking-widest relative z-10">Or Quick Test</span>
          </div>

          <button
            onClick={handleDemoSignIn}
            className="w-full py-3 rounded-2xl border border-dashed border-primary-500/30 text-primary-500 hover:bg-primary-500/5 font-semibold text-xs transition-colors"
          >
